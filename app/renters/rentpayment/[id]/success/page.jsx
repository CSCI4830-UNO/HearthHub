...
export default async function SuccessPage({ searchParams }) {
  ...
  return (
    <div id="payment-status">
      ...
      {paymentIntent && <a href={`https://dashboard.stripe.com/payments/${paymentIntentId}`} id="view-details" target="_blank">View payment details
      ...
      <a id="retry-button" href="/renters/dashboard">Dashboard</a>
    </div>
  );
}