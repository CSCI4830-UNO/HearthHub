					...
					<CardContent className="pt-6">
						<div className="text-center space-y-3">
							...
							<p className="text-muted-foreground">
								You don't have any active leases yet. Once you sign a lease,
								you'll be able to contact your landlord here.
							</p>
						</div>
					</CardContent>
				</Card>
				...
				{selectedTenancy ? (
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Contact{" "}
								{selectedTenancy.landlord_name} about{" "}
								{selectedTenancy.property_name}
							</CardDescription>
						</CardHeader>
						<CardContent>
								...
								{success && (
									<div className="flex items-center gap-2 p-3 bg-green-50 border border-green-200 rounded-md">
										...
										<p className="text-sm text-green-800">
											Message sent successfully! Your landlord will receive an
											email shortly.
										</p>
									</div>
								)}
